...
const About = () => {
  return (
    <section id="about" className="relative py-24 bg-slate-950 text-white overflow-hidden border-t border-white/5 selection:bg-purple-500/30">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <Reveal className="mb-16">
            <SectionKicker index="01" label="About" accent="cyan" />
        ...
        {/* --- BENTO GRID LAYOUT --- */}
        <Reveal delay={100} className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 auto-rows-[minmax(180px,auto)]">
            ...
            <div className="md:col-span-2 lg:col-span-2 row-span-2 relative group overflow-hidden rounded-3xl bg-slate-900/40 border border-white/10 p-8 backdrop-blur-md hover:border-cyan-500/30 transition-colors duration-500">
                ...
                <p className="text-slate-400 text-lg leading-relaxed">
                    My work spans <span className="text-purple-400 font-semibold">applied NLP research</span>, freelance full-stack builds for real businesses, and data-driven decision support. I transform raw noise into clean, actionable intelligence.
                </p>
            </div>
            ...
            <div className="md:col-span-1 lg:col-span-2 relative rounded-3xl bg-gradient-to-br from-slate-900 to-slate-800 border border-white/5 p-6 overflow-hidden group">
                ...
                <div className="flex flex-wrap gap-2">
                    {['Python', 'SQL', 'React.js', 'Flask', 'FastAPI', 'TensorFlow', 'MongoDB', 'Power BI', 'Gemini AI', 'Data Viz'].map((tech) => (
