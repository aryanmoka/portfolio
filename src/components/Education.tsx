...
const Education = () => {
  ...
  return (
    <section id="education" className="relative py-24 bg-slate-950 text-white overflow-hidden border-t border-white/5">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <Reveal className="mb-20 text-center">
            <div className="inline-flex justify-center w-full">
              <SectionKicker index="05" label="Academic Timeline" accent="amber" />
            </div>
        ...
        <div className="relative max-w-4xl mx-auto">
            ...
            <div className="space-y-12">
                {education.map((item, index) => {
                    ...
                    return (
                        <Reveal key={item.id} delay={index * 100} y={30}>
                            ...
                            <div className="w-full md:w-[calc(50%-3rem)] pl-12 md:pl-0">
                                <div className={`group relative overflow-hidden rounded-2xl bg-slate-900 border border-white/10 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl ${isCurrent ? 'ring-2 ring-cyan-500/50 shadow-cyan-500/20' : ''}`}>
                                    ...
                                    <div className="absolute inset-0 z-0">
                                        <img src={item.image} alt={`${item.degree} background`} loading="lazy" decoding="async" className="w-full h-full object-cover opacity-20 transition-transform duration-700 group-hover:scale-110 grayscale group-hover:grayscale-0" />
