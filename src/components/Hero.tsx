      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 h-full flex flex-col justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className={`lg:col-span-7 flex flex-col items-start text-left transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            {/* Mobile-only compact avatar (hidden on lg where the big card takes over) */}
            <div className="lg:hidden relative w-24 h-24 rounded-2xl overflow-hidden border border-white/10 mb-6 shadow-2xl shrink-0">
              <div className="absolute inset-0 bg-gradient-to-tr from-cyan-500 to-purple-500 blur-xl opacity-40"></div>
              <img
