...
const Certificates: React.FC = () => {
  ...
  const certificates: Certificate[] = [
    ...
    {
      id: 'CERT-006',
      title: 'Complete React & Next.js (AI-Powered Projects)',
      issuer: 'Udemy',
      link: '#',
  ...
  return (
    <section id="certificates" className="relative py-24 bg-slate-950 text-white overflow-hidden border-t border-white/5">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 max-w-7xl">
        ...
        <Reveal className="flex flex-col items-center mb-16">
          <SectionKicker index="06" label="Verified Credentials" accent="emerald" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {certificates.map((cert, idx) => (
            <Reveal key={cert.id} delay={(idx % 3) * 80}>
            <div
